...
const char *ts_help_set[] = {
	...
	"    \2AKILL <on/off>\2         - Tells SecureServ to never issue a Akill on your Network. A warning message is sent to the operators instead",
	...
	"    \2MULTICHECK <on/off>\2    - Makes SecureServ check all Patterns when a infected User is found.",
